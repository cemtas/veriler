...
def format_tamsayi(deger, sembol=""):
    try:
        ...
        # Sayıyı en yakın tam sayıya yuvarla, binlik ayraç olarak virgül koy, sonra o virgülü noktaya çevir
...
def canli_ve_altbant_verilerini_cek():
    ...
    # HATA DÜZELTİLDİ: ONS Altın verisi artık Türkçe formatta (is_tr=True) okunduğu için kusursuz çalışır
...
st.markdown("<h3 style='color: #00e5ff; font-size: 32px; margin-bottom: 5px; margin-top: 0; text-align: center; position: relative; z-index: 10; font-weight: 700; text-shadow: 0px 2px 5px rgba(0,0,0,0.8);'>LIVE MARKET DATA</h3>", unsafe_allow_html=True)
...
st.markdown("<h3 style='color: #00e5ff; font-size: 32px; margin-bottom: 5px; margin-top: 0; text-align: center; position: relative; z-index: 10; font-weight: 700; text-shadow: 0px 2px 5px rgba(0,0,0,0.8);'>AVERAGE (M-1)</h3>", unsafe_allow_html=True)
...
<div style="text-align: center; margin-top: 15px; margin-bottom: 10px; position: relative; z-index: 10;">
    <span style="font-family: 'Segoe UI Light', 'Helvetica Neue', Arial, sans-serif; font-size: 22px; font-weight: 300; font-style: italic; color: #cbd5e1; letter-spacing: 3px; text-shadow: 0px 1px 3px rgba(0,0,0,0.5);">Powered by Cem TAŞ</span>
</div>
"""
st.markdown(imza_html, unsafe_allow_html=True)

# KAYAN YAZI (Tüm küsuratlar atıldı, binlik ayracı nokta yapıldı)
kayan_str = (
